...
# --- Register all tools in a local registry ---

tool_registry = ToolRegistry()

tool_registry.register(READ_PLANTS_DATA_SCHEMA, handle_read_plants_data)
tool_registry.register(READ_USER_INFO_SCHEMA, handle_read_user_info)
tool_registry.register(GET_PLANT_COORDINATES_SCHEMA, handle_get_plant_coordinates)
tool_registry.register(FIND_NEAREST_PLANT_SCHEMA, handle_find_nearest_plant)
tool_registry.register(GET_ACCESS_LEVEL_SCHEMA, handle_get_access_level)
tool_registry.register(GET_PERSON_LOCATIONS_SCHEMA, handle_get_person_locations)
tool_registry.register(SUBMIT_ANSWER_SCHEMA, handle_submit_answer)
tool_registry.register(SAVE_AGENT_SCHEMA, handle_save_agent)
